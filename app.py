...
class Bill_App:
    def __init__(self,root):
        ...
        #===========Frame Content
        maza_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Maaza")
...
#Function to get total prices
    def total(self):
        ...
        self.tax_cgst.set("Rs. "+str(round(self.total_cgst*0.10)))
        self.tax_sgst.set
...
#Function For Text Area
    def welcome_soft(self):
        ...
        self.txt.insert(END,"       Welcome To Iconic Retail\n")
...
#Add Product name , qty and price to bill area
    def bill_area(self):
        ...
        if self.maza.get() != 0:
            self.txt.insert(END,f"\nMaaza              {self.maza.get()}           {self.maza.get() * 20}")
